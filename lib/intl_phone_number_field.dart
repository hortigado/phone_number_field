...
class _InternationalPhoneNumberInputState extends State<InternationalPhoneNumberInput> {
  ...
  void initState() {
    ...
    if (widget.initDialCode != null && countries != null) {
      selected = countries!.firstWhere(
        (element) => element.dial_code == widget.initDialCode,
      );
    }
